...
`news-monitor` skill. For a fourth source this skill can eventually distill from, see the
`email-agent` skill, which logs deal-flow and portfolio updates from email threads into the same
entity folder.
